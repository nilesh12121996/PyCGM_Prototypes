...
class pyCGM():
    ...
    def get_pelvis_joint_center(self):
        return self.pelvis_joint_center[0]
...
class customCGM(pyCGM):

    @staticmethod
    @parameters('RASI', 'LASI', 'RPSI', 'LPSI', 'SACR', 'MeanLegLength')
    def calc_pelvis_joint_center(self, rasi, lasi, rpsi, lpsi, sacr, mean_leg_length):
